...
const Edit_Form = () => {
  ...
  useEffect(() => {
    fetchData("http://103.228.83.115:8081/api/v1/countries", setCountries);
    fetchData("http://103.228.83.115:8081/api/v1/states", setStates);
    fetchData("http://103.228.83.115:8081/api/v1/cities", setCities);
    fetchData(`http://103.228.83.115:8081/api/v1/vendors/${params.id}`, setVendorData);
  }, [params.id]);
  ...
  useEffect(() => {
    const fetchVendorData = async () => {
      try {
        const response = await fetch(`http://103.228.83.115:8081/api/v1/vendors/${params.id}`);
        if (!response.ok) {
