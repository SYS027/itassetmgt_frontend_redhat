...
const [productTypes, setProductTypes] = useState([]);
  ...
  useEffect(() => {
    ...
    fetchData(`https://itassetmgt-7659d44ac774.herokuapp.com/api/v1/asset/${params.id}`, setAssetData);
  }, [params.id]);
  ...
  const updateData = async (e) => {
    e.preventDefault();
    const url = `https://itassetmgt-7659d44ac774.herokuapp.com/api/v1/asset/${id}`;
    const data = {
