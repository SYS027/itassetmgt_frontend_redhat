...
function AssignAssetEdit() {
  ...
  const fetchAssignAssetData = async () => {
    try {
      const response = await fetch(
        `https://itassetmgt-7659d44ac774.herokuapp.com/api/v1/assign_assets/${params.id}`
      );
      const data = await response.json();
      setId(data.id);
  ...
  const handleEditSubmit = (e) => {
    ...
    fetch(`https://itassetmgt-7659d44ac774.herokuapp.com/api/v1/assign_assets/${id}`, {
      method: "PUT",
  ...
  const productdata = async () => {
    try {
      const response = await fetch(
        "https://itassetmgt-7659d44ac774.herokuapp.com/api/v1/products"
      );
      const data = await response.json();
      setProduct(data);
    } catch (error) {
